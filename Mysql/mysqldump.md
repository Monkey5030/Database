*. 无建表信息 批量插入  
`mysqldump  -uroot -h127.0.0.1 -p  --no-create-info -c --add-locks=0   --skip-tz-utc   --skip-comments   --skip-set-charset    databasename tablename --result-file=/mnt/tablename.sql`
